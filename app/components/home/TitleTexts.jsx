    ...
    return (
        <div className="w-[100vw] md:w-full -mt-8 sm:-mt-0 lg:ml-0  flex flex-col justify-center items-center text-center px-4 h-[234px] xl:-mt-7">
            <div className="max-w-4xl">
                <p className="text-[22px] leading-[38px] sm:text-[35px] xl:text-[50px] font-light font-nordiquePro sm:leading-[60px]">
                    Building A Data Driven
                </p>
                <p className="text-[25px] leading-[40px] sm:text-[35px] xl:text-[60px] font-bold sm:leading-[60px] tracking-wide font-ceraRoundPro">
                    Marketing Agency
                </p>
            </div>

    ...
    >
      {services.map((service, index) => (
        <>
          <div
            key={index}
            className="h-fit w-full snap-start sticky top-[100px] flex items-start gap-7 p-[10px] xl:pb-32"
          >
            <motion.div
            ...
            >
              <p className="text-outline font-thin text-transparent">
            ...
            <div className="flex flex-col lg:flex-row justify-between h-full px-0 mx-auto">
              <motion.div
                ...
                transition={{ duration: 0.8, ease: "easeOut" }}
              >
                <h2 className="text-lg xl:text-[2.8rem] 2xl:text-[3.5rem] font-bold leading-none">
                  {service.title}
                </h2>

...
export default function Portfolio({ page }) {
  ...
  const handleMenuClick = (index) => {
    ...
    const timer = setTimeout(() => setAutoplayEnabled(true), PAUSE_DURATION);
  ...
  const activeItem = page.menuItems[activeIndex];
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 bg-zinc-900 w-full xl:max-h-[550px] 2xl:max-h-[690px] font-raleway">
      ...
      <div className="w-full h-full flex flex-col bg-zinc-900 text-white">
        <motion.div
          key={activeItem.image} // ensures animation triggers on change

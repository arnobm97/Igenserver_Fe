...
export const portableTextComponents = {
  ...
  types: {
    ...
    subtitle: ({ value: { value } }) => (
      <h2 className="text-2xl font-semibold my-3">{value}</h2>
    ),
    tip: ({ value: { value } }) => (
      <div
        className={`bg-[#2D2D2D] text-white p-6 rounded-lg shadow-2xl border border-gray-600 max-w-2xl mx-auto`}
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-gray-200 leading-relaxed space-y-2">
              <p className="text-base text-orange-300 font-medium">{value}</p>
            </div>
          </div>
        </div>
      </div>

...
export default function ChatbotMainScreen({ handleClose }) {
  ...
  return (
    <div className="h-full w-full xl:px-[40px] py-[20px] z-[100] flex flex-col justify-between relative font-raleway">
      ...
      {!messages.length && (
        <div className="absolute top-0 left-0 w-full h-full flex justify-center -z-[1]">
            ...
            {messages.map((message, index) => (
              ...
              >
                <div className="w-full flex flex-col gap-2">
                  <div
                    className={`w-full xl:w-max xl:max-w-[70%] flex flex-col gap-3 rounded-2xl px-6 py-4 text-sm xl:text-base ${
                      message.sender === "user"
        ...
        {!messages.length && (
          <div className="">
            ...
            <div className="flex flex-wrap justify-center items-center w-full gap-2 text-gray-300 text-sm">
              <StyledButton
                name="Ultimate Enterprise Solution"
                handleClick={(text) => {
        ...
        <div className="w-full flex flex-col gap-3 rounded-[20px] bg-black overflow-hidden text-white py-3 px-5 xl:px-[35px]">
          ...
          <div className="w-full flex justify-between items-center">
            ...
            <button
              ...
              className="bg-orange-500 px-6 py-2 rounded-full hover:bg-primary duration-300"
            >
              <ArrowUp />
            </button>
          </div>
